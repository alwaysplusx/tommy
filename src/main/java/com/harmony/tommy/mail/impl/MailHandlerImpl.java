package com.harmony.tommy.mail.impl;
...
import com.harmony.tommy.mail.Mail;
import com.harmony.tommy.mail.MailHandler;
import com.harmony.tommy.mail.MailTemplet;
...
public class MailHandlerImpl implements MailHandler {
    ...
    /**
     * 创建邮件基础信息.发送人/接收人/抄送人/密送人/主题/发送时间 邮件正文未填写
     * 
     * @param mail
     * @return
     * @throws Exception
